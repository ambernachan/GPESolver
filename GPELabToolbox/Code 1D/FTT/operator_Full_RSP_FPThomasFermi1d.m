...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi{n} = GPE_Phi{n} + ifft((FFTPhysics1D.Dispersion{n,n}/2 + FFTPhysics1D.StochasticDispersion{n,n}/1).*fft(Phi{n})); % Computing the wave function with the Laplacian operator applied
end
