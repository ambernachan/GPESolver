...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = Phi{n} + ifft2((1/Method.Deltat + FFTPhysics2D.Dispersion{n,n}/2 + FFTPhysics2D.StochasticDispersion{n,n}/2).^(-1).*fft2(GPE_Phi)); % Computing the IFFT of the wave function with the operators applied then apply the Laplace preconditioner
