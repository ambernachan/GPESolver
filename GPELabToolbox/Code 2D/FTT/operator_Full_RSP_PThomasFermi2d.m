...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = GPE_Phi + ifft2((FFTPhysics2D.Dispersion{n,n}/2 + FFTPhysics2D.StochasticDispersion{n,n}/2).*fft2(Phi{n})); % Computing the wave function with the Laplacian operator applied
