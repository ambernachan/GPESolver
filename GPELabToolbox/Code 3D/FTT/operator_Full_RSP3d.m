...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = GPE_Phi + 1/Method.Deltat*Phi{n} ...
        + ifftn((FFTPhysics3D.Dispersion{n,n}/2 + FFTPhysics3D.StochasticDispersion{n,n}/2).*fftn(Phi{n})); % Computing the wave function with the potential, nonlinear and Laplacian operators applied
