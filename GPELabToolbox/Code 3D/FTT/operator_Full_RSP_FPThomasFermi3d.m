...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi{n} = GPE_Phi{n} + ifftn((FFTPhysics3D.StochasticDispersion{n,n}/2 + FFTPhysics3D.Dispersion{n,n}/2).*fftn(Phi{n})); % Computing the wave function with the Laplacian operator applied
end
