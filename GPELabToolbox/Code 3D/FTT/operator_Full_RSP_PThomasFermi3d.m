...
for n = 1:Method.Ncomponents
    ...
    GPE_Phi = GPE_Phi + ifftn((-FFTPhysics3D.Delta*(FFTOperators3D.Dx+FFTOperators3D.Dy+FFTOperators3D.Dz)/2 + FFTPhysics3D.Dispersion{n,n}/2 + FFTPhysics3D.StochasticDispersion{n,n}/2).*fftn(Phi{n})); % Computing the wave function with the Laplacian operator applied
