...
for n = 1:Method.Ncomponents
    ...
    FFTGPE_Phi{n} = fftn(GPE_Phi) ...
       + (1/Method.Deltat - FFTPhysics3D.Dispersion{n,n}/2 - FFTPhysics3D.StochasticDispersion{n,n}/2).*fftn(Phi{n}); % Computing the wave function with the potential, nonlinear and Laplacian operators applied
end
