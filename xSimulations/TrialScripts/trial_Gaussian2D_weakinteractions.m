...
%     chi = 0.01; xlimit = 3; xparticles = 2^5+1; ylimit = xlimit; yparticles = 2^5+1;
    ...
    clearvars -except path wspath info2
    ...
    plot_1d_graph(xx,phixN,gphixN,tfphixN,xlim1,ylimit_x,'x',Redge,S,w,dx)
    ...
    plot_1d_graph(yy,phiyN,gphiyN,tfphiyN,xlim1,ylimit_y,'y',Redge,S,w,dy)
    ...
    if nplots > 1
        close all;
        %%%%%%%%%%%%%%%%%%%%% % graph(-1,1)
        plot_1d_graph(xx,phixN,gphixN,tfphixN,xlim2,ylimit_x,'x',Redge,S,w,dx)
        ...
        close all;
        plot_1d_graph(yy,phiyN,gphiyN,tfphiyN,xlim2,ylimit_y,'y',Redge,S,w,dy)
        ...
        close all;
        %%%%%%%%%%%%%%%%%%%%% % graph(-0.1,0.1)
        plot_1d_graph(xx,phixN,gphixN,tfphixN,xlim3,ylimit_x,'x',Redge,S,w,dx)
        ...
        close all;
        plot_1d_graph(yy,phiyN,gphiyN,tfphiyN,xlim3,ylimit_y,'y',Redge,S,w,dy)
